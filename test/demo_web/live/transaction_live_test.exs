defmodule DemoWeb.TransactionLiveTest do
  use DemoWeb.ConnCase

  import Phoenix.LiveViewTest
  import Demo.StatisticFixtures

  @create_attrs %{quantity: 42, total_price: "120.5", transaction_date: "2025-01-23T07:12:00Z"}
  @update_attrs %{quantity: 43, total_price: "456.7", transaction_date: "2025-01-24T07:12:00Z"}
